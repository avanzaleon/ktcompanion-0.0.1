...
(function(){
  ...
  function hit(o,x,y){
    if(o.type==='pen'){const pts=o.pts||[];for(let i=1;i<pts.length;i++)if(segDist(x,y,pts[i-1].x,pts[i-1].y,pts[i].x,pts[i].y)<=14)return true;return pts.some(p=>pointDist(x,y,p.x,p.y)<=16)}
    if(o.type==='area'){const r=pointDist(o.a.x,o.a.y,o.b.x,o.b.y),dist=pointDist(x,y,o.a.x,o.a.y);return Math.abs(dist-r)<=16||dist<r+10}
    return segDist(x,y,o.a.x,o.a.y,o.b.x,o.b.y)<=16;
  }
